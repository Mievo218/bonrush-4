...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-4626c785');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-4626c785');}
...
var brandEl=document.querySelector('.rl-brand-4626c785');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
